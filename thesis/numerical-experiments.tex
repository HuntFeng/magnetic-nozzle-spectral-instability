...
\begin{figure}[H]
	...
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/fixed-fixed-constant-v-v0=0.5}
		\caption{All modes are stable.}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/fixed-fixed-constant-v-v0=1.5}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/fixed-open-constant-v-v0=0.5}
		\caption{All modes are stable.}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/fixed-open-constant-v-v0=1.5}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/fixed-fixed-subsonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/fixed-open-subsonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/fixed-fixed-supersonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/fixed-open-supersonic-v}
	\caption{All modes are unstable.}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/results-accelerating-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/results-decelerating-v}

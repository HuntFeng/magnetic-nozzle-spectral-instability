...
\begin{figure}[H]
	...
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/numerical-experiments/fixed-fixed/constant-v-v0=0.5}
		\caption{All modes are stable.}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/numerical-experiments/fixed-fixed/constant-v-v0=1.5}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/numerical-experiments/fixed-open/constant-v-v0=0.5}
		\caption{All modes are stable.}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=\linewidth]{img/numerical-experiments/fixed-open/constant-v-v0=1.5}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/numerical-experiments/fixed-fixed/subsonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/numerical-experiments/fixed-open/subsonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/numerical-experiments/fixed-fixed/supersonic-v}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/numerical-experiments/fixed-open/supersonic-v}
	\caption{All modes are unstable.}
